...
class LoaderTest extends TestCase {
	...
	public function testGetCacheKeyNoPlugin() {
		$this->assertSame(PLUGIN_REPO_ROOT . 'tests/test_app/Template/layout.tpl', $this->Loader->getCacheKey('layout'));
	}

	public function testGetCacheKeyPlugin() {
		$this->assertSame(PLUGIN_REPO_ROOT . 'tests/test_app/Plugin/TestTwigView/Template/twig.tpl', $this->Loader->getCacheKey('TestTwigView.twig'));
	}
